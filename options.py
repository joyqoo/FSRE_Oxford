...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "test", "robotcar", "robotcar_mini", "robotcar_odd", "robotcar_full"],
                                 default="robotcar_full")
        self.parser.add_argument("--dataset",
                                 type=str,
                                 help="dataset to train on",
                                 default="robotcar_full",
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", "robotcar", "robotcar_mini", "robotcar_odd", "robotcar_full"])
